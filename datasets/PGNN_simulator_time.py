...
class PGNNDataset_simulator(PyGdata.Dataset):
    def __init__(
        ...
        self.bzmesh_file = p + "/bext.txt"
        self.bzmesh, self.pts = ReadBEXT(self.bzmesh_file, 1)
...
class PGNNDataset_new(PyGdata.Dataset):
    def __init__(
        self,
        file_path,
        recursive,
        ...
        # super(PGNNDataset, self).__init__(root, transform, pre_transform)
