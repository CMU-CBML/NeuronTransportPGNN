...
from datasets.PGNN_tree import PGNNDataset_tree
from model.PGNN_simulator_time import Simulator, SimulatorModel
from model.PGNN_tree import GN_tree
...
def train(args):
    ...
    if args.data_fname is not None:
        ...
        dataset = PGNNDataset_tree(data_fname)
